...
const gabry = {
  ...
  focus: ["AI Pipelines", "Auth Platforms", "Cloud Migrations"],
  building: "n8n-starter - GitOps for n8n with AI agent integration", 
  homelab: "39+ Docker stacks and counting",
  dailyDriver: "Neovim + zellij + zen",
  music: "Electronic production (when the terminal is closed)"
};
```
